...
| AdPlacement               | string    | ICF, No Matches, After Matches, API, High School, Ad Unit, Organic Exit Pop, Paid Search Exit Pop, Program Listings - Widget, Program Listings - Static* | 
